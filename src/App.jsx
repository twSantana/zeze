...
function AppContent({ theme, onThemeToggle }) {
  ...
  // Mostra mensagem de erro amigável quando o Supabase não está configurado nas variáveis de ambiente
  if (!isSupabaseConfigured) {
    return (
      <div className="w-screen h-screen flex flex-col items-center justify-center bg-slate-900 text-white font-sans gap-4 p-6">
        ...
        <p className="text-sm text-slate-300 max-w-xl text-center">Supabase não configurado corretamente. Verifique as variáveis de ambiente.</p>
